...
import json
import torch
from Depression.model import NeuralNet
from Depression.data_learning import bag_of_words, tokenize

device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')
with open('depression.json', 'r', errors='ignore') as f:
...
if __name__ == "__main__":
    ...
    while True:
        ...
        resp = get_response_dep(sentence)
        print(resp)
